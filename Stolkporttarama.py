...
print("%"*30)
print("Amaç Dışı Kullanımda Kullanan Kişi Sorumludur\n Programlayan >> Stolker\n Koswog.com")
print("%"*30)
...
mp3_fp = BytesIO()
tts = gTTS('Lütfen Editleyip Paylaşmayınız', 'tr')
tts.write_to_fp(mp3_fp)

giris=int(input("Lütfen Seçeneği Giriniz : "))
...
if giris==1:
    ...
    print("1) port tarama\n")
    print("*"*30)
    giris=int(input("Lütfen işlemi giriniz : "))
